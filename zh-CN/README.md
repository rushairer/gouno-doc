...
官方 `gouno-template` 是参考实现。它选择的 Gin、Cobra、Viper、Flat Layered 架构以及具体 Generator 名称，都不是 Gouno Core 对所有项目的强制要求。
...
- [架构 Profile](./architecture-profiles.md) — 在 Flat Layered 与 Capability Module 两种参考 Profile 之间做选择
...
Architecture Profiles 是由 `gouno-doc` 维护的生态级工程指导，仍然属于 Project/Template 约定，不是 Gouno Core 协议要求。
...
| [gouno-template](https://github.com/rushairer/gouno-template) | 官方默认 Flat Layered Template 与参考 Codegen Policy |
