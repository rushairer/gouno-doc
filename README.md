...
The official template is a reference implementation. Its Gin/Cobra/Viper choices, layered architecture, and concrete generator names are not requirements imposed by Gouno Core.
...
| [gouno-template](https://github.com/rushairer/gouno-template) | Official default template and reference Codegen policy |
